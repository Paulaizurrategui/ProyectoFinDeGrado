...
Esta guía explica, de forma detallada, cómo utilizar UrTriply desde el primer acceso hasta la interacción en la comunidad.

#### 1. Primer acceso y creación de cuenta

1. Abre la aplicación y espera a que cargue la pantalla de bienvenida.
2. Si ya tienes cuenta, selecciona **Iniciar sesión**.
3. Si aún no tienes cuenta, pulsa **Registrarse**.
4. Completa los campos requeridos (correo electrónico, contraseña y datos básicos).
5. Marca la confirmación de edad mínima (+13), requisito obligatorio para usar la plataforma.
6. Finaliza el registro y accede con tu nueva cuenta.

**Recomendaciones:**
1. Usa un correo que consultes con frecuencia para posibles avisos de recuperación de cuenta.
2. Elige una contraseña segura (mínimo 8 caracteres, combinación de letras y números).

#### 2. Inicio de sesión y recuperación de contraseña

1. En la pantalla de acceso, introduce tu correo y contraseña.
2. Pulsa **Iniciar sesión** para entrar en la aplicación.
3. Si no recuerdas tu contraseña, utiliza la opción **¿Olvidaste tu contraseña?**.
4. Sigue el proceso de recuperación mediante correo electrónico.
5. Vuelve a la app, inicia sesión con la nueva contraseña y verifica que el acceso funciona correctamente.

#### 3. Navegación general de la app

1. Tras iniciar sesión, llegarás a la pantalla principal (Home).
2. Usa la barra de navegación inferior para moverte entre secciones.
3. Las pestañas principales son:
   - **Home**: resumen de actividad y acceso rápido.
   - **Plan**: creación de propuestas de viaje.
   - **Community**: publicaciones de otros usuarios.
   - **Profile**: datos personales, preferencias y contenido guardado.
4. Puedes volver atrás desde la flecha de navegación sin perder la sesión.

#### 4. Crear una propuesta de viaje paso a paso

1. Entra en la pestaña **Plan**.
2. Selecciona el destino de entre las ciudades disponibles.
3. Introduce los parámetros clave:
   - Presupuesto total.
   - Número de viajeros.
   - Rango de fechas (inicio y fin).
   - Preferencias (cultura, ocio, naturaleza, gastronomía, etc.).
4. Revisa los datos antes de continuar para evitar resultados poco ajustados.
5. Pulsa **Generar viaje**.
6. Espera unos segundos mientras la app consulta fuentes externas y construye la propuesta.

**Importante:**
1. El sistema prioriza datos reales de APIs externas.
2. Si una API no responde, se aplican estimaciones transparentes para mantener la propuesta disponible.

#### 5. Interpretar el resultado generado

1. Al terminar la generación, accede a la pantalla de resultado del viaje.
2. Revisa cada bloque de información:
   - **Vuelos**: opciones orientativas, precio aproximado y enlace cuando esté disponible.
   - **Alojamiento**: sugerencias de hoteles/zonas con referencia de coste.
   - **Actividades**: puntos culturales, ocio y visitas recomendadas.
   - **Presupuesto**: distribución por categorías para facilitar el control del gasto.
   - **Itinerario**: propuesta por días para organizar mejor el viaje.
3. Si el resultado no se ajusta a lo que necesitas, regresa al formulario y modifica presupuesto, fechas o preferencias.

#### 6. Guardar, editar y publicar viajes

1. Desde el resultado, guarda el viaje como borrador si quieres revisarlo más tarde.
2. Accede a tus viajes guardados desde perfil o sección correspondiente.
3. Edita campos relevantes antes de publicar (por ejemplo, texto de descripción o ajustes finales).
4. Publica el viaje cuando esté listo para compartir con la comunidad.
5. Si lo necesitas, puedes eliminar o actualizar tus propias publicaciones posteriormente.

#### 7. Compartir contenido

1. Abre el viaje generado o publicado.
2. Pulsa **Compartir** para enviar la propuesta mediante aplicaciones externas (mensajería, correo, etc.).
3. Comprueba que el contenido compartido incluye la información más útil (destino, coste estimado e itinerario).
4. Si se incluye un enlace de reserva, este se abrirá dentro de la app.

#### 8. Uso de la comunidad

1. Entra en la pestaña **Community** para explorar viajes publicados.
2. Filtra o revisa publicaciones según tus intereses.
3. Interactúa con las publicaciones:
   - Da **like** si te gusta una propuesta.
   - Añade a **favoritos** para guardarla y revisarla más tarde.
   - Escribe comentarios para preguntar detalles o aportar sugerencias.
4. Abre el detalle de cada publicación para ver toda la información del plan.
5. Visita perfiles de otros usuarios para descubrir más viajes y contenido relacionado.

#### 9. Gestión de perfil y preferencias

1. Accede a la pestaña **Profile**.
2. Revisa y actualiza tus datos personales disponibles.
3. Consulta tus favoritos, publicaciones y actividad reciente.
4. Ajusta preferencias visuales como modo oscuro.
5. Cierra sesión desde el perfil cuando uses un dispositivo compartido.

#### 10. Moderación, reportes y seguridad en la comunidad

1. Si detectas contenido inapropiado, utiliza la opción **Reportar** en publicaciones o comentarios.
2. Selecciona el motivo del reporte de forma clara.
3. Si un usuario te molesta, utiliza la opción de bloqueo cuando esté disponible.
4. Los perfiles con rol de administración pueden revisar reportes y aplicar moderación.

#### 11. Problemas frecuentes y soluciones rápidas

1. **No puedo iniciar sesión**:
   - Verifica correo y contraseña.
   - Comprueba tu conexión a internet.
   - Usa recuperación de contraseña si es necesario.
2. **El viaje tarda en generarse**:
   - Espera unos segundos adicionales.
   - Revisa la conexión de red.
   - Reduce filtros muy restrictivos y vuelve a intentar.
3. **No se muestran algunos datos externos**:
   - Puede haber una incidencia temporal en APIs de terceros.
   - La app aplicará estimaciones para no interrumpir la experiencia.
4. **Un enlace no abre correctamente**:
   - Intenta de nuevo desde la misma pantalla.
   - Verifica que tienes navegador actualizado o permisos necesarios.

#### 12. Buenas prácticas de uso

1. Revisa siempre precios y condiciones antes de comprar o reservar.
2. Contrasta información clave (horarios, políticas de cancelación, ubicación).
3. Mantén la app actualizada para obtener mejoras de estabilidad y seguridad.
4. Evita publicar datos personales sensibles en comentarios públicos.
5. Utiliza favoritos para organizar mejor ideas de viaje y comparar alternativas.

#### 13. Flujo recomendado para un nuevo usuario

1. Registrarse e iniciar sesión.
2. Configurar preferencias básicas en el perfil.
3. Generar un primer viaje con presupuesto realista.
4. Revisar el resultado y guardarlo como borrador.
5. Ajustar detalles y publicar en comunidad si se desea.
6. Interactuar con otras publicaciones para obtener inspiración y feedback.
