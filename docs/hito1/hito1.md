...
- Personas con un perfil digital básico, pero que buscan funcionalidades completas sin complicaciones.
...
- **Vuelos:** búsqueda dentro del rango de fechas y selección del precio más bajo. Salida: precio + enlace para compra.
...
- Publicar viaje generado 
- Publicar un viaje manual 
- Ver feed/lista de viajes de otros 
- Comentar publicaciones 
- Dar like 
- Guardar en favoritos 
- Reportar publicaciones/comentarios
...
- **RNF-03 (Fiabilidad):** Si una fuente externa falla, la app debe usar fallback estimado y avisar.
...
# 7. Mockups iniciales (bocetos funcionales)

## 7.1. Pantalla 0 — Bienvenida / Acceso
- Logo + eslogan
- Botones:
  - “Iniciar sesión”
  - “Crear cuenta”
...
## 7.4. Pantalla 3 — Home (usuario registrado)
...
## 7.5. Pantalla 4 — Formulario “Planificar viaje”
...
## 7.6. Pantalla 5 — Resultado de propuesta
...
## 7.8. Pantalla 7 — Detalle publicación + comentarios
...
## 7.10. Pantalla 9 — Admin (solo admin)
- Lista de reportes
- Acciones:
  - ocultar/borrar post
  - borrar comentario
